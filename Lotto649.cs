...
//Description: A Lotto649 Windows form that has two buttons(which writes, reads and display the random
//numbers in and from a textfile) and two textboxes(one displaying random numbers from 1-49 and the other
//from 0-9).
//Date:07/18/2023
